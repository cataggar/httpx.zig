...
export const SITE_DESCRIPTION = "A high-performance HTTP client and server library for Zig with HTTP/1.x, HTTP/2, concurrency, proxy support, and experimental HTTP/3 protocol primitives.";
    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: "Proxies & SOCKS5h", link: "/guide/proxies" },
      ...
      },
      {
        ...
        items: [
          ...
          { text: "Multipart Form Data", link: "/guide/multipart" },
          { text: "Session Management", link: "/guide/sessions" },
          { text: "Observability Metrics", link: "/guide/metrics" },
        ],
      },
      {
        text: "Protocol",
      ...
      },
      {
        ...
        items: [
          ...
          { text: "HTTP/2 Advanced", link: "/examples/http2-advanced" },
          ...
          { text: "HTTP/3 Advanced", link: "/examples/http3-advanced" },
          ...
          { text: "Session Store", link: "/examples/session-example" },
          ...
          { text: "Compression", link: "/examples/compression-example" },
          { text: "HTTP Methods", link: "/examples/http-methods" },
          { text: "Retry", link: "/examples/retry-example" },
          { text: "DNS Resolution", link: "/examples/dns-example" },
          { text: "DNS Cache", link: "/examples/dns-cache" },
          { text: "DNS Configuration", link: "/examples/dns-configuration" },
          { text: "DNS Resolve All", link: "/examples/dns-resolve-all" },
          { text: "Streaming Compression", link: "/examples/streaming-compression-example" },
          { text: "HTTP Cache", link: "/examples/http-cache-example" },
          { text: "Redirect", link: "/examples/redirect-example" },
          { text: "Batch Concurrent", link: "/examples/batch-concurrent" },
          { text: "Reverse Proxy Middleware", link: "/examples/reverse-proxy-middleware" },
          { text: "JSON API", link: "/examples/json-api-example" },
          { text: "Pre-Route Hooks", link: "/examples/pre-route-example" },
          { text: "Readiness Probe", link: "/examples/readiness-probe-example" },
          { text: "TLS Server", link: "/examples/tls-server" },
          { text: "HTTPS Client", link: "/examples/https-client" },
          { text: "TLS HTTPS GET", link: "/examples/tls-https-get" },
          { text: "TLS Config Options", link: "/examples/tls-config-options" },
          { text: "TLS Handshake Details", link: "/examples/tls-handshake-details" },
          { text: "TLS Custom CA", link: "/examples/tls-custom-ca" },
          { text: "TLS mTLS", link: "/examples/tls-mtls" },
          { text: "WebSocket Server", link: "/examples/websocket-server" },
          { text: "Transfer Download", link: "/examples/transfer-download" },
          { text: "Transfer Checksum", link: "/examples/transfer-checksum" },
          { text: "Transfer Progress", link: "/examples/transfer-progress" },
      ...
      },
      {
        ...
        items: [
          ...
          { text: "IO API", link: "/api/io" },
          { text: "Compression API", link: "/api/compression" },
          { text: "Cache API", link: "/api/cache" },
          { text: "Data Formats API", link: "/api/data" },
          { text: "Metrics API", link: "/api/metrics" },
          { text: "Session API", link: "/api/session" },
          { text: "SSE API", link: "/api/sse" },
